...
for key, value in portals.items():
	os.system("curl 'https://signon.jgi.doe.gov/signon/create' --data-urlencode 'login=mbrockley@middlebury.edu' --data-urlencode 'password=Dumbledore{19}' -c cookies > /dev/null")
